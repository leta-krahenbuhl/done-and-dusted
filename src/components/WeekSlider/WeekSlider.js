...
export default function WeekSlider({ setCurrentWeek }) {
    ...
    return (_jsxs("div", { className: "week-slider", children: [_jsx("button", { onClick: goToPreviousWeek, className: "tasks-button", children: "\u2190" }), _jsx("h2", { children: formattedWeekStart }), _jsx("button", { onClick: goToNextWeek, className: "tasks-button", children: "\u2192" })] }));
}
